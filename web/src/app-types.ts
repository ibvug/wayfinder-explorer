import type { LayoutPoint, Location } from "../../src/model.ts";
import type { WritebackPlanView } from "../../src/expedition/model.ts";
import type { DirectoryPickerPurpose } from "../../src/project/directory-picker.ts";
import type { MapCreationPlanView } from "../../src/charting/model.ts";
import type { AgentApprovalDecision } from "../../src/codex/approval.ts";
import type { ExplorerSnapshot } from "../../src/service/model.ts";

export type CampaignSnapshot = ExplorerSnapshot;
