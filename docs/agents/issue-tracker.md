...
Create a new file under `.scratch/<feature-slug>/`, creating the directory if needed. Do not create or update a remote issue unless the user explicitly asks to switch trackers.
